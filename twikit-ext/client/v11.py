...
Endpoint.UPDATE_PROFILE_IMAGE = f"https://api.{DOMAIN}/1.1/account/update_profile_image.json"
Endpoint.UPDATE_PROFILE_BANNER = f"https://api.{DOMAIN}/1.1/account/update_profile_banner.json"
